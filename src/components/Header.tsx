...
const Header = () => {
  ...
  return (
    <header className={`${scrolled ? 'bg-white/95 backdrop-blur-sm border-b border-gray-200' : 'bg-transparent border-0 backdrop-blur-0'} sticky top-0 z-50 transition-colors duration-300`}>
